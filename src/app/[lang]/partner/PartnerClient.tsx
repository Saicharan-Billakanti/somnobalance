            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-2xl bg-sand/30 p-4 text-xs">
                ...
                <p className="mt-1 font-bold text-teal-dark text-sm">
                  {portalData.affiliate.defaultCommissionRate || 15}% {tx("per verified sale", "je verifiziertem Verkauf")}
                </p>
              </div>
            </div>
          </div>
          ...
          {activeTab === "overview" && (
            <div className="mt-12 space-y-12 animate-fade-in">
              ...
              <div className="rounded-3xl border border-mauve/10 bg-gradient-to-br from-sand/50 to-sand/20 p-8 text-center sm:p-12">
                <h2 className="font-serif text-2xl text-ink">{tx("Ready to partner with SomnoBalance?", "Bereit für eine Partnerschaft mit SomnoBalance?")}</h2>
                <p className="mx-auto mt-3 max-w-xl text-sm text-ink/70">
                  {tx("Apply in less than two minutes. Once approved, you receive your unique promo code and 15% commission on every referral.", "Bewerben Sie sich in weniger als zwei Minuten. Nach der Freigabe erhalten Sie Ihren persönlichen Gutscheincode und 15 % Provision auf jede Empfehlung.")}
                </p>
                <div className="mt-6 flex flex-wrap justify-center items-center gap-4">
                  ...
                  >
                    {tx("Already a partner? Log in →", "Bereits Partner? Anmelden →")}
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto mt-12 max-w-2xl rounded-3xl border border-mauve/10 bg-white/80 p-8 shadow-sm sm:p-10 animate-fade-in">
              {formSuccess ? (
                <div className="py-8 text-center flex flex-col items-center">
                  ...
                  >
                    {tx("Log In to Your Account", "Bei Ihrem Konto anmelden")}
                  </Link>
                </div>
              ) : (
