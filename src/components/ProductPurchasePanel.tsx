  ...
  return (
    <div className="space-y-6">
            ...
            {product.variants.map((v) => (
              <button
                ...
                className={`rounded-full border px-4 py-2 text-sm ${
                  selected === v.label
                    ? "border-mauve bg-mauve/10 text-mauve-dark font-medium"
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
        <div>
          <div className="text-2xl font-serif font-bold text-mauve-dark">
        ...
        <div className="flex items-center rounded-full border border-mauve/20 bg-sand/30 p-1">
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-ink/70 hover:bg-sand transition text-sm font-bold shadow-xs"
          ...
          <input
            ...
            className="w-12 bg-transparent text-center font-bold text-ink text-sm focus:outline-none"
          />
          <button
            type="button"
      ...
      {isVolumeOrder && (
        <div className="rounded-2xl border border-amber-300 bg-amber-50/70 p-4 shadow-sm animate-fade-in">
          <div className="flex items-start gap-3">
            <span className="text-xl">💼</span>
            <div className="space-y-1 text-xs">
              <div className="font-bold text-amber-950">
                Ordering in bulk ({qty} units)? Get Business Discounts!
              </div>
              <p className="text-amber-900/80 leading-relaxed">
                Hotels, clinics, yoga studios, and corporate practices unlock <strong>15% to 30% OFF</strong> and custom tax invoicing via our B2B program.
              </p>
      ...
      <div className="rounded-2xl border border-mauve/15 bg-sand/30 p-4 space-y-2 text-xs">
        <div className="flex items-center justify-between">
          <span className="font-bold text-teal-dark flex items-center gap-1.5">
        ...
        <div className="text-ink/70 leading-relaxed text-[11px] pt-1 border-t border-mauve/10">
          <strong className="text-ink font-semibold">🔒 Return & Refund Condition:</strong>{" "}
          {product.refundRules ||
